...
public class YoutubeStepDef {
	...
	@When("^search dua lipa songs playlist$")
	public void search_dua_lipa_songs_playlist() throws Throwable {
	...
	public void validate_channel_title() throws InterruptedException {
		String expected = "Dua Lipa - New Rules (Official Music Video) - YouTube";
